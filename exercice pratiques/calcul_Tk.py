...
label_resultat = tk.Label(resultat,textvariable=operation,font=("consolat",35),bg="white",width=24,height=2)
label_resultat.pack()
...
btn13 = tk.Button(Bouttons,text="2",height="5",width="10",fg="white",bg="#505050",command=lambda: button_click(2))
btn13.place(x=80,y=240)

btn13 = tk.Button(Bouttons,text="3",height="5",width="10",fg="white",bg="#505050",command=lambda: button_click(3))
btn13.place(x=160,y=240)

btn14 = tk.Button(Bouttons,text="+",height="5",width="10",bg="#FF9500",fg="white",command=lambda: button_click('+'))
btn14.place(x=240,y=240)

#ligne 5

btn15 = tk.Button(Bouttons,text="0",height="5",width="22",fg="white",bg="#505050",command=lambda: button_click(0))
btn15.place(x=0,y=320)

btn16 = tk.Button(Bouttons,text=".",height="5",width="10",fg="white",bg="#505050",command=lambda: button_click('.'))
btn16.place(x=160,y=320)

btn17 = tk.Button(Bouttons,text="=",height="5",width="10",bg="#FF9500",fg="white",command=lambda: button_click('='))
btn17.place(x=240,y=320)
